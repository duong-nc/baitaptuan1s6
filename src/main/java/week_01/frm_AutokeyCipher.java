 ...
 * @author canhduong
 */
public class frm_AutokeyCipher extends javax.swing.JFrame {

    /**
     * Creates new form frm_AutokeyCipher
     */
    public frm_AutokeyCipher() {
        initComponents();
    }
...
if (!ciphertext.isEmpty() && !key.isEmpty()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_AutokeyCipher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_AutokeyCipher().setVisible(true);
            }
        });
    }
